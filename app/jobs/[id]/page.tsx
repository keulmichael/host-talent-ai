...
export default async function JobPage({params}:{params:Promise<{id:string}>}){
 ...
 return <>
  <div className="card"><div className="eyebrow">MISSION · V2.3 · MODULE 04</div><h1>{job.title}</h1><p className="muted">{job.clientName||"Client non renseigné"} · {job.location||"Localisation non renseignée"}</p><p>{job.description}</p>
