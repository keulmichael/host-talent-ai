...
export default async function Dashboard(){
 ...
 const[jobCount,candidateCount,matchCount,recentJobs,topMatches,activePipeline,strong,expiring,privateFiles,shortlisted,activeShares,feedbackCount,dueActions,overdueActions,webhookCount,templateCount]=await Promise.all([
 ...
 return <>
  <div className="hero"><div><div className="eyebrow">COPILOTE RECRUTEUR · V2.2 · MODULE 02</div><h1>Du vivier à l'orchestration relationnelle.</h1><p className="muted">{user.organization.name} · matching explicable, centre d'actions, SLA, modèles cabinet, connecteurs universels et suivi candidat.</p></div><div className="actions"><Link className="btn" href="/jobs/new">Créer une mission</Link><Link className="btn secondary" href="/actions">Centre d'actions</Link><Link className="btn secondary" href="/search">Recherche sémantique</Link><Link className="btn secondary" href="/pipeline">Pipeline</Link><RecomputeAllButton/></div></div>
