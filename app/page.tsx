...
export default async function Dashboard(){
 ...
 return <>
  <div className="hero"><div><div className="eyebrow">COPILOTE RECRUTEUR · V2.3 · MODULE 04</div><h1>Du vivier à l'expérience candidat mesurée.</h1><p className="muted">{user.organization.name} · matching explicable, orchestration relationnelle, SLA et observatoire de l'expérience candidat.</p></div><div className="actions"><Link className="btn" href="/jobs/new">Créer une mission</Link><Link className="btn secondary" href="/actions">Centre d'actions</Link><Link className="btn secondary" href="/experience">Observatoire candidat</Link><Link className="btn secondary" href="/search">Recherche sémantique</Link><Link className="btn secondary" href="/pipeline">Pipeline</Link><RecomputeAllButton/></div></div>
