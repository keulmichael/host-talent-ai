...
export default async function Dashboard(){
  ...
  const funnel=[
    ...
    {label:"Candidats prioritaires uniques",value:priorityCandidates.length,meta:"meilleur matching retenu par candidat"},
    {label:"Validations métier",value:validationCandidateCount,meta:"sur le meilleur matching : indispensable ou écart souhaitable significatif"}
  ];
  ...
  return <>
    ...
    <section className="kpiRow">
      ...
      <div className="kpiCard"><span>Infos commerciales</span><strong>{commercialCandidateCount}</strong><small>sur les candidats prioritaires : disponibilité, TJM ou salaire</small></div>
    ...
    <section className="workflowStrip"><div><strong>Analyser</strong><span>Tous les matchings automatiquement</span></div><b>→</b><div><strong>Prioriser</strong><span>Meilleur matching par candidat</span></div><b>→</b><div><strong>Valider</strong><span>Seulement les écarts métier significatifs</span></div><b>→</b><div><strong>Compléter</strong><span>Disponibilité, TJM et salaire séparément</span></div></section>
  </>;
}
