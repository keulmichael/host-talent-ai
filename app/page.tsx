...
export default async function Dashboard(){
 ...
 const[jobCount,candidateCount,matchCount,recentJobs,topMatches,activePipeline,strong,expiring,privateFiles]=await Promise.all([
 ...
 return <>
  <div className="hero"><div><div className="eyebrow">COPILOTE RECRUTEUR · V1.7</div><h1>Du vivier au suivi opérationnel.</h1><p className="muted">{user.organization.name} · espace cloisonné. Matching explicable, recherche sémantique locale, stockage privé des CV et pilotage de la conservation.</p></div><div className="actions"><Link className="btn" href="/jobs/new">Créer une mission</Link><Link className="btn secondary" href="/search">Recherche sémantique</Link><Link className="btn secondary" href="/pipeline">Pipeline</Link><RecomputeAllButton/></div></div>
